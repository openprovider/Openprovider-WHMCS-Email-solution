...
add_hook('AdminProductConfigFieldsSave', 1, function ($vars) {
    try{
        ...
        logModuleCall('Email Account',__FUNCTION__,$vars,$e->getMessage(),['error'=>$e->getMessage()]);
    }
});
...
function createConfigurableOption($pid)
{
    try {
        ...
        logModuleCall('Email Account',__FUNCTION__,$pid,$e->getMessage(),['error'=>$e->getMessage()]);
    }
}
